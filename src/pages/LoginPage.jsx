            ...
            <div className="app-layout" style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: 'clamp(24px, 5vh, 64px)', zIndex: 1 }}>
                    <div style={{
                        ...
                        <Icon name="cloud" size={80} style={{ color: 'var(--primary)' }} />
                    </div>
                    <h1 style={{ fontSize: 'clamp(28px, 4vh, 42px)', letterSpacing: -1.5, color: '#ffffff', fontWeight: 900, marginBottom: 4 }}>
                        SMART <span style={{ background: 'linear-gradient(135deg, var(--primary), var(--accent))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>BUSINESS OS</span>
                    </h1>
                    <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 'clamp(14px, 1.8vh, 18px)', fontWeight: 500, letterSpacing: 0.5 }}>Business Management Platform</p>
                </div>
